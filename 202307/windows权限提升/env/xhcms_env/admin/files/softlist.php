...
$total = mysql_fetch_array(mysql_query("select count(*) from download WHERE id>0"));      
...
$query=mysql_query("select * from download ORDER BY id DESC limit $startnum,$perpagenum ") ;
...
?>
                        <tr>
                          ...
                          <td>
<a href="/?r=software&cid=<?php echo $list['id']?>" target="_blank"><button class="btn btn-xs btn-success"><i class="icon-ok"></i> </button></a>
<a href="?r=editsoft&id=<?php echo $list['id']?>"><button class="btn btn-xs btn-warning"><i class="icon-pencil"></i> </button></a>
<a href="?r=softlist&delete=<?php echo $list['id']?>" onClick="return confirm('操作警告：\n\n请注意，删除可能会影响整个系统关联项\n\n您确定要删除吗？') "><button class="btn btn-xs btn-danger"><i class="icon-remove"></i> </button></a>
