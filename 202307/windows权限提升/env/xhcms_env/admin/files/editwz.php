...
<!-- Sidebar ends -->
  	...
  	<div class="mainbar">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">编辑文章</a>
        </div>
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" method="post" action=""  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input name="title" type="text" class="form-control" placeholder="title" value="<?php echo $contents['title']?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="col-lg-4 control-label">作者</label>
                                  <div class="col-lg-8">
                                    <input type="text" name="author" class="form-control" placeholder="author" value="<?php echo $contents['author']?>">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" name="keywords" class="form-control" placeholder="keywords" value="<?php echo $contents['keywords']?>">
                                  </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" name="description" class="form-control" placeholder="description" value="<?php echo $contents['description']?>">
                                  </div>
                                </div>
                                 <div class="form-group">
...
<input name="xs" type="checkbox" id="inlineCheckbox1" value="0" <?php if ($contents['xs']==0){echo 'checked="CHECKED"';}?>> 隐藏
</label>
<label class="checkbox-inline">
<input type="checkbox" name="toutiao" id="inlineCheckbox2" value="1" <?php if ($contents['toutiao']==1){echo 'checked="CHECKED"';}?>> 头条
                                    </label>
                                  </div>
                                </div>
...
<?php
$navclass=$contents['navclass'];
$query=mysql_query("select * FROM navclass");
while($listclass = mysql_fetch_array($query)){ 
?>
<option value="<?php echo $listclass['id'] ?>" <?php if ($navclass==$listclass['id']){ echo 'selected="selected"';}?>><?php echo $listclass['name'] ?></option>
<?php }?>
                                    </select>
                                  </div>
                                </div>   
