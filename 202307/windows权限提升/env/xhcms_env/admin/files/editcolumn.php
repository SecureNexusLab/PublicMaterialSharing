...
<div class="col-lg-8">
<input name="keywords" type="text" class="form-control"  value="<?php echo $nav['keywords']?>">
</div>
</div>
<div class="form-group">
<label class="col-lg-4 control-label">描述</label>
<div class="col-lg-8">
<input name="description" type="text" class="form-control"  value="<?php echo $nav['description']?>">
</div>
</div>
<div class="form-group">
<label class="col-lg-4 control-label">排序</label>
<div class="col-lg-8">
<input name="px" type="text" class="form-control"  value="<?php echo $nav['px']?>">
</div>
</div>
<div class="form-group">
...
<input name="xs" type="checkbox" value="0" <?php if ($nav['xs']<>1){echo 'checked="CHECKED"';}?>> 隐藏
</label>
<?php if ($type==2){?>
<label class="checkbox-inline">
<input name="tuijian" type="checkbox" value="1" <?php if ($nav['tuijian']==1){echo 'checked="CHECKED"';}?>> 推荐
</label>
<?php }?> 
</div>
</div>
<?php if ($type==1 AND (($nav['type']==1) OR ($nav['type']==4) OR ($nav['type']==5))){?>
<div class="form-group">
<label class="col-lg-4 control-label">内容</label>
<div class="col-lg-8">
<textarea name="content" id="editor"><?php echo $nav['content']?></textarea>
</div>
</div>    
<?php }?>                   
 <hr />
