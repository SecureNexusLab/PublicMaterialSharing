...
<!-- Sidebar ends -->
  	...
  	<div class="mainbar">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">发表软件</a>
        </div>
                     ...
                     <form class="form-horizontal" role="form" method="post" action=""  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" name="daxiao" class="form-control" placeholder="daxiao">
                                  </div>
                                </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" name="softadd" class="form-control" placeholder="softadd">
                                  </div>
                                </div>
                             ...
                             <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" name="softadd2" class="form-control" placeholder="softadd2">
                                  </div>
                                </div>
                                 <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <input type="text" name="demo" class="form-control" placeholder="demo">
                                  </div>
                                </div>
                                <div class="form-group">
